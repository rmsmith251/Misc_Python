# When I downloaded pyPDF2 onto my machine, the FlateDecode class only had filterbytes to 2.
# You may have to change the class to the below code if you get an error that the filterbytes
